            ...
            <div className="instructions">
                <div className="instructions__steps">
                    <div className="instructions__step">
                        ...
                        <CustomButton className="instructions__button" text={"Submit your input"} icon={"arrow"} />
                    </div>
                    <div className="instructions__step">
                        <div>
                        ...
                        <CustomButton className="instructions__button" text={"Make an account"} icon={"arrow"} />
                    </div>
                    <div className="instructions__step">
                        <div>
