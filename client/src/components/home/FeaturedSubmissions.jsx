...
export function FeaturedSubmission({ submission, imgURL, openModal }) {
    const charAmount = 60;
    ...
    return (
        <>
            ...
            <div className="submission--page" onClick={openModal}>
...
export default function FeaturedSubmissions({ featuredSubmissions, issueDate, imgURL, openModal }) {

    return (

        featuredSubmissions.length > 0 ? (
            <div className="featured-submissions" id="featured-submissions">
                ...
                <div className="featured-submissions__submissions">
                    {featuredSubmissions.map((submission, index) => (
                        <div key={index} className="submission">
                            <FeaturedSubmission submission={submission} imgURL={imgURL} openModal={openModal} />
                        </div>
                    ))}
                </div>
